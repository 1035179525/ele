...
@section("content")
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <input type="text" class="form-control" id="inputEmail3"  name="num" value="{{old("num")}}">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="date" class="form-control" id="inputEmail3"  name="prize_time" value="{{old("prize_time")}}">
            </div>
        </div>
        <div class="form-group">
