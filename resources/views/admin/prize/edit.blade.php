...
@section("content")
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" id="inputEmail3"  name="name" value="{{old("name",$prize->name)}}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <select name="event_id" class="form-control">
                    ...
                    <option value="{{$event->id}}" {{$event->id==$prize->event_id?"selected":""}}>{{$event->title}}</option>
                        @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                ...
                <script id="container" name="description" type="text/plain">
                  {!!old("description",$prize->description) !!}
                </script>
            </div>
        </div>
        <div class="form-group">
